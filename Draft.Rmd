...
# Visual of relationship between PM
origin |> ggplot(aes(x=lon, y=value)) + 
  geom_point() + geom_smooth() + 
  labs(title="PM2.5 Concentration (mu g/m^3)", x="Longitude ()", y="PM2.5")
...
# Check performance of lin. regr. model on the complete training data
res1 %>% 
    extract_fit_engine() %>% 
    summary()

# Check  lin. regr. model performance using cross-validation
