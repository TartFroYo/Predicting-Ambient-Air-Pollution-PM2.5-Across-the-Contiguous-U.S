...
=======
train_scaled = train %>% select(-id) %>% dplyr::select(where(is.numeric)) %>% mutate(across(fips:aod, scale)) %>% cbind(state=train$state,county=train$county,city=train$city)
>>>>>>> 38b1173b074a8bd5d01817978ba5405967c9e4ee
